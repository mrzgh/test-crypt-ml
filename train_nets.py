...
def train_speck_distinguisher(num_epochs, num_rounds=7, depth=1):
    ...
    X, Y = speck.make_train_data(2 ** 20, num_rounds)

    #generate evaluation data
    X_eval, Y_eval = speck.make_train_data(2 ** 10, num_rounds)

    #print(f"Y = {Y}")
    #X, Y = speck.make_train_data(10**7,num_rounds)
    #X_eval, Y_eval = speck.make_train_data(10**6, num_rounds)
